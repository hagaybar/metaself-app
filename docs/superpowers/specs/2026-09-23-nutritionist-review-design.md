...
> figures it holds and where each came from, what one of it is called, and what one of it weighs.
> Nothing else goes with it — no other food, not what or when you ate, not your weight, age, goal or
